...
<div class="header_bg_b">
    ...
    <div class="f_r" style="padding-right: 10px;">
        ...
        <link href="/Public/Home//css/style.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript" src="/Public/Admin/jquery-1.7.2.js"></script>
        <script type="text/javascript" src="/Public/Home/layer/layer.js"></script>

        <div class="block box">
            <div class="blank"></div>
            <div id="ur_here">
                当前位置: <a href="#">首页</a> <code>&gt;</code> <a href="#">手机类型</a> <code>&gt;</code> <a href="#">GSM手机</a> <code>&gt</code> <?php echo ($datas["goods_name"]); ?>
            </div>
        </div>
        <div class="blank"></div>
        ...
        <div class="block clearfix">
            ...
            <div class="AreaR">
                <div id="goodsInfo" class="clearfix">
                    <div class="imgInfo">
                        <a style="position: relative; display: block; outline: 0pt none; text-decoration: none; width: 310px; -moz-user-select: none;" href="/Public/Home/images/200905/goods_img/9_P_1241511871575.jpg" id="zoom1" class="MagicZoom MagicThumb" title="<?php echo ($datas[0]["goods_name"]); ?>">
                            <img id="sim806035" src="/Public/Uploads/<?php echo ($datas["goods_big_pic"]); ?>" alt="<?php echo ($datas[0]["goods_name"]); ?>" height="310px" width="310px;" />
                        ...
                        <div class="blank5"></div>
                         <?php if(is_array($pic_data)): foreach($pic_data as $k=>$v): ?><div class="picture" id="imglist">
                            <a style="outline: 0pt none;" href="/Public/Home/images/200905/goods_img/9_P_1241511871575.jpg" rel="zoom1" rev="images/200905/goods_img/9_P_1241511871575.jpg" title="">
                                <img src="/Public/Uploads/<?php echo ($v["pic_small"]); ?>" alt="<?php echo ($datas["goods_name"]); ?>" class="onbg" /></a>
                    ...
                    <div class="textInfo">
                        <form action="" method="post" name="ECS_FORMBUY" id="cart_form">
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品重量：<?php echo ($datas["goods_weight"]); ?></strong>
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                        <strong>上架时间：<?php echo (date('Y-m-d',$datas["goods_addtime"])); ?></strong>
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品点击数： <?php echo ($datas["goods_click"]); ?></strong>      </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                        <strong>市场价格：</strong><font class="market">￥<?php echo ($datas["goods_price"]); ?>元</font><br />

                                        <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥<?php echo ($datas["goods_mprice"]); ?>元</font><br />
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>购买数量：</strong>
     <a id="addn" href="javascript:void(0);">+</a>
     <input name="number" id="number" value="1" size="4" onblur="changePrice()" style="border: 1px solid rgb(204, 204, 204);" type="text" /><a id="deln" href="javascript:void(0);">-</a>
                                    </dd>
                                </li>
...
<!-- 加入收藏 -->
                                <?php if(is_array($attr_data)): foreach($attr_data as $k=>$v): ?><li class="padd loop">
                                    <strong><?php echo ($v["attr_name"]); ?>:</strong>
                                    <?php if(is_array($v["val_attr"])): foreach($v["val_attr"] as $k=>$vv): ?><label for="spec_value_227">
                                        <input name="attr_val[<?php echo ($v["attr_name"]); ?>]" <?php if($k == 0): ?>checked<?php endif; ?>
                      value="<?php echo ($vv); ?>" id="spec_value_227" type="radio" />
                                        <?php echo ($vv); ?> </label><?php endforeach; endif; endforeach; endif; ?>
                                    <input name="goods_id" value="<?php echo ($datas["id"]); ?>" type="hidden" />
                                </li>
                                <li class="padd">
                                    <a href="javascript:void(0);" id="goumai"><img src="/Public/Home/images/goumai2.gif"></a>
                                    <a href="javascript:void(0);" id="gouwuche"><img src="/Public/Home/images/shoucang2.gif"></a>
                    ...
                    <script type="text/javascript">
                        $(function(){
                            ...
                            $('#goumai').click(function(){
                                ...
                                <?php else: ?>
                                layer.open({
                                    type: 1,   //弹出框的类型  1.弹出div层，2.弹出iframe 框架
                                    title: '用户登录',
                                    // fix: false,
                                    // maxmin: true,
                                    // shadeClose: true,
                        ...
                        function login_submit(){
                            ...
                            //发送ajax请求 并且判断用户登录是否成功
                            $.post('<?php echo U("user/login");?>',{'username':username,'password':pwd},function(data){
                                if(data.status==1){
