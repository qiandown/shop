...
<div class="header_bg_b">
    ...
    <div class="f_r" style="padding-right: 10px;">
        ...
        <div class="block">
            ...
            <input type="hidden" name="goods_datas" value='<?php echo ($form_goods_data); ?>'>
                ...
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <?php if(is_array($order_data)): foreach($order_data as $key=>$o): ?><tr>
                                <td>
                                    <a href="#" target="_blank" class="f6"><?php echo ($o["cart_goods_name"]); ?></a>
                                </td>

                                <td>
                                <?php if(is_array($o[goods_attr])): foreach($o[goods_attr] as $key=>$oo): echo ($key); ?>:<?php echo ($oo); ?> <br /><?php endforeach; endif; ?>
                                </td>
                                <td align="right">￥<?php echo ($o["cart_mprice"]); ?>元</td>
                                <td align="right">￥<?php echo ($o["cart_price"]); ?>元</td>
                                <td align="right"><?php echo ($o["cart_count"]); ?></td>
                                <td align="right">￥<?php echo ($o[cart_price]*$o[cart_count]); ?>元</td>
                ...
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody>
						  ...
						  <?php if(is_array($addr_data)): foreach($addr_data as $key=>$d): ?><tr>
                                <td><input <?php if($d[is_default] == 1): ?>checked<?php endif; ?> type="radio" value="<?php echo ($d["id"]); ?>" name="addr_id"></td>
                                <td><?php echo ($d["addr_name"]); ?>    <?php echo ($d["addr_address"]); ?> <?php echo ($d["addr_phone"]); ?></td>
              ...
              <div class="blank"></div>
                ...
                <div class="flowBox">
                    ...
                    <div id="ECS_ORDERTOTAL">
                        ...
                        <input src="/Public/Home/images/bnt_subOrder.gif" value="订单提交" type="submit" />
