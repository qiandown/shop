            ...
            <div class="AreaR">
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="screeBox">
                            <strong>品牌：</strong>
                            <?php if($_GET['brand_id']== 0): ?><span>全部</span>
                            <?php else: ?>
                             
                             <a href="/index.php/Home/Goods/showlist/brand_id/0">全部</a>&nbsp;<?php endif; ?>


                            <?php if(is_array($brand_datas)): foreach($brand_datas as $key=>$d): if($_GET['brand_id']== $d[id]): ?><a href="#"><span><?php echo ($d["brand_name"]); ?></span></a>&nbsp;
                            <?php else: ?>
                             <a href="/index.php/Home/Goods/showlist/brand_id/<?php echo ($d["id"]); ?>"><?php echo ($d["brand_name"]); ?></a>&nbsp;<?php endif; endforeach; endif; ?>
                        </div>

                        <div class="screeBox">
                            <strong>价格：</strong>
                             <?php if($_GET['price']== '0'): ?><span>全部</span>
                             <?php else: ?>
                            
                            <a href="/index.php/Home/Goods/showlist/brand_id/<?php echo ($brand_id); ?>/price/0">全部</a>&nbsp;<?php endif; ?>
                            <?php if(is_array($price_data)): foreach($price_data as $k=>$d): if($_GET['price']== $k): ?><a href="#"><span><?php echo ($d); ?></span></a>&nbsp;
                                <?php else: ?>
                            <a href="/index.php/Home/Goods/showlist/brand_id/<?php echo ($brand_id); ?>/price/<?php echo ($k); ?>"><?php echo ($d); ?></a>&nbsp;<?php endif; endforeach; endif; ?>
                        </div>
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                                ...
                                <?php if(is_array($datas)): foreach($datas as $key=>$d): ?><div class="goodsItem">
                                    <a target="_blank" href="<?php echo U('goods/detail','id='.$d[id]);?>"><img src="/Public/Uploads/<?php echo ($d["goods_small_pic"]); ?>" alt="<?php echo ($d["goods_name"]); ?>" class="goodsimg"></a><br />
                                    <p><a target="_blank" href="<?php echo U('goods/detail','id='.$d[id]);?>" title="<?php echo ($d["goods_name"]); ?>"><?php echo ($d["goods_name"]); ?></a></p>
