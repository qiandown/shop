        ...
        <div class="block">
            <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1">
                        <tbody><tr>
                            ...
                            <?php if(is_array($cart_datas)): foreach($cart_datas as $key=>$d): ?><tr>
                                <td align="center">
                                    <a href="#" target="_blank"><img style="width: 80px; height: 80px;" src="/Public/Uploads/<?php echo ($d["goods_small_pic"]); ?>" title="P806" /></a><br />
                ...
                <table cellpadding="5" cellspacing="0" width="99%">
                    <tbody><tr>
                            <td><a href="<?php echo U('goods/showlist');?>"><img src="/Public/Home/images/continue.gif" alt="continue" /></a></td>
                            <td align="right"><a href="<?php echo U('order/show');?>"><img src="/Public/Home/images/checkout.gif" alt="checkout" /></a></td>
                        </tr>
                    </tbody></table>
            </div>
            <div class="blank"></div>
...
<script src="/Public/Common/jquery-1.7.2.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function(){
        ...
        $('.cart_del').click(function(){
            ...
            //使用ajax里面的post
            $.post('/index.php/Home/Cart/del',{goods_id:id},function(){
