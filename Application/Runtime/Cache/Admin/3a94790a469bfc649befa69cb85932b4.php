...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="<?php echo U('brand/update');?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo ($brandList["id"]); ?>">
            <table border="1" width="100%" class="table_a">
                <tr>
                    <td>商品名称</td>
                    <td><input type="text" name="brand_name" value="<?php echo ($brandList["brand_name"]); ?>" /></td>
                </tr>
                <tr>
                    <td>商品分类</td>
                    <td>
